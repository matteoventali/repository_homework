	...
	\section{Manuale utente}
		...
		In questo capitolo vengono descritte le modalità di utilizzo delle funzionalità offerte agli utenti del sistema, come riportato nei casi d'uso. \ref{CasiUso}
			...
			\subsection{Inserimento domande e risposte}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[height=7cm, frame=2pt]{"screenInserimentoRisposta.png"}	
				\end{figure}
			...
			\subsection{Ricariche portafoglio standard}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=\textwidth, frame=2pt]{"screenRichiestaRicarica.png"}	
				\end{figure}
			...
			\subsection{Gestione FAQ}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[height=6cm, frame=2pt]{"screenInserimentoFaq.png"}	
				\end{figure}
