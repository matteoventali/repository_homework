...
\begin{document}
	...
	\section{Introduzione e descrizione dei dati}
		...
		\subsection{Casi d'uso}
			...
			\bigskip
			\subsubsection{Recensioni e domande}
			\textbf{Precondizioni}
			\begin{itemize}
				\item l'utente ha effettuato il login come cliente;
			...
			\textbf{Eventi}
			\begin{enumerate}
				\item il cliente raggiunge la sezione \textit{Recensioni} o la sezione \textit{Domande};
				\item il cliente inserisce la recensione o la domanda.
			\end{enumerate}
			\textbf{Postcondizioni}
			\begin{itemize}
				\item la recensione o la domanda saranno visibili sulla pagina del prodotto in oggetto.
			\end{itemize}
			...
			\begin{itemize}
				\item l'utente ha effettuato il login come admin/gestore/cliente;
				\item l'utente ha selezionato un prodotto dal catalogo.
			\end{itemize}
			\textbf{Eventi}
			\begin{enumerate}
				\item l'utente raggiunge la sezione \textit{Domande};
			...
			\begin{itemize}
				\item l'utente ha effettuato il login come admin/gestore/cliente;
				\item l'utente raggiunge la sezione \textit{Recensioni} o \textit{Domande}.
			\end{itemize}
			\textbf{Eventi}
			\begin{enumerate}
